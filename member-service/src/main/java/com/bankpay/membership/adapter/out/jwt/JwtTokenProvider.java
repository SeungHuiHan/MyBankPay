package com.bankpay.membership.adapter.out.jwt;

import com.bankpay.membership.application.port.out.AuthMembershipPort;
...
public class JwtTokenProvider implements AuthMembershipPort {
    ...
    public boolean validateJwtToken(String jwtToken) {
        try {
            Jwts.parser().setSigningKey(jwtSecret).build().parseClaimsJws(jwtToken);
            return true;

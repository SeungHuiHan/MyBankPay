...
//        }
    ...
    void registerRegisteredBankAccountByEvent(@RequestBody RegisterBankAccountRequest request) {

        System.out.println("Received RegisterBankAccountRequest: " + request);

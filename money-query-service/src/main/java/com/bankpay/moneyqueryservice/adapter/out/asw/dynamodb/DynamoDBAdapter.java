...
import com.bankpay.moneyqueryservice.application.port.out.GetMoneySumByAddressPort;
...
public class DynamoDBAdapter implements GetMoneySumByAddressPort, InsertMoneyIncreaseEventByAddress {
    ...
    private static final String ACCESS_KEY = "AKIAXEFUNF253W3OKREU";
    private static final String SECRET_KEY = "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";
    ...
    //pk와 sk 둘다 넣어서 하나의 row만 나올 수 있는 쿼리
    ...
    //pk와 sk등으로 n개의 데이터를 얻어오기 위해 쿼리하는것
